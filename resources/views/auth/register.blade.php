                ...
                <div class="account-area">
                    ...
                    <form class="account-form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="@error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                            @error('name')
                    ...
                    <div class="option">
                        ¿Ya tienes una cuenta? <a href="{{ url('/login') }}">Login</a>.
                    </div>
